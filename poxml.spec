...
Version  : 25.04.2
Release  : 78
URL      : https://download.kde.org/stable/release-service/25.04.2/src/poxml-25.04.2.tar.xz
Source0  : https://download.kde.org/stable/release-service/25.04.2/src/poxml-25.04.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/25.04.2/src/poxml-25.04.2.tar.xz.sig
...
%setup -q -n poxml-25.04.2
cd %{_builddir}/poxml-25.04.2
pushd ..
cp -a poxml-25.04.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1749480125
mkdir -p clr-build
pushd clr-build
