...
Source0  : https://download.kde.org/stable/applications/19.08.2/src/poxml-19.08.2.tar.xz
Source1 : https://download.kde.org/stable/applications/19.08.2/src/poxml-19.08.2.tar.xz.sig
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1570783225
mkdir -p clr-build
pushd clr-build
