...
Version  : 21.12.2
Release  : 37
URL      : https://download.kde.org/stable/release-service/21.12.2/src/poxml-21.12.2.tar.xz
Source0  : https://download.kde.org/stable/release-service/21.12.2/src/poxml-21.12.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/21.12.2/src/poxml-21.12.2.tar.xz.sig
...
%prep
%setup -q -n poxml-21.12.2
cd %{_builddir}/poxml-21.12.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1643992577
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/poxml-21.12.2/COPYING %{buildroot}/usr/share/package-licenses/poxml/a21ac62aee75f8fcb26b1de6fc90e5eea271854c
cp %{_builddir}/poxml-21.12.2/COPYING.DOC %{buildroot}/usr/share/package-licenses/poxml/fcbf818f92ef8679a88f3778b12b4c8b5810545b
cp %{_builddir}/poxml-21.12.2/cmake/modules/COPYING-CMAKE-SCRIPTS %{buildroot}/usr/share/package-licenses/poxml/ff3ed70db4739b3c6747c7f624fe2bad70802987
pushd clr-build
%make_install
popd
