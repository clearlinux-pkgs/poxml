...
Source0  : https://download.kde.org/stable/release-service/20.04.1/src/poxml-20.04.1.tar.xz
Source1  : https://download.kde.org/stable/release-service/20.04.1/src/poxml-20.04.1.tar.xz.sig
...
%prep
%setup -q -n poxml-20.04.1
cd %{_builddir}/poxml-20.04.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1589830615
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/poxml-20.04.1/COPYING %{buildroot}/usr/share/package-licenses/poxml/a21ac62aee75f8fcb26b1de6fc90e5eea271854c
cp %{_builddir}/poxml-20.04.1/COPYING.DOC %{buildroot}/usr/share/package-licenses/poxml/fcbf818f92ef8679a88f3778b12b4c8b5810545b
cp %{_builddir}/poxml-20.04.1/cmake/modules/COPYING-CMAKE-SCRIPTS %{buildroot}/usr/share/package-licenses/poxml/ff3ed70db4739b3c6747c7f624fe2bad70802987
pushd clr-build
%make_install
popd
